...
class MainActivity : FlutterActivity() {
    ...
    private fun startGattServer() {
        // Stop existing server first to avoid duplicate services
        gattServer?.close()
        gattServer = null
    ...
    private val advertiseCallback = object : AdvertiseCallback() {
        ...
        override fun onStartFailure(errorCode: Int) {
            ...
            // Error codes: 1=ALREADY_STARTED 2=DATA_TOO_LARGE 3=TOO_MANY_ADVERTISERS 4=INTERNAL_ERROR 5=FEATURE_UNSUPPORTED
        }
    }
